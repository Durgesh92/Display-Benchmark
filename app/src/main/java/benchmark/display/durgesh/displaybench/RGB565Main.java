 ...
 */
public class RGB565Main extends Fragment {
    ...
    class validate_opengl_pixel extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            System.out.println("Final Output ==> "+splited_op[actual_index+1]);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mGLView = new OpenGLRGB_565Surface(getContext());
