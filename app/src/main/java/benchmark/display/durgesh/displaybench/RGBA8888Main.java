 ...
 */
public class RGBA8888Main extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mGLView = new OpenGLRGBA_8888Surface(getContext());
        if(suAvailable.matches("true")){
            new validate_opengl_pixel().execute();
        }
        float alpha = 0.9f;
        //mGLView.setAlpha(alpha);
        System.out.println("Alpha Value ==> "+mGLView.getAlpha());
        return mGLView;
    }
}
