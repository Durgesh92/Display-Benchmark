 ...
 */
public class RGBA4444Main extends Fragment {
        ...
        protected void onPostExecute(Void result) {
            ...
            for (int i= 0 ;i<splited_op.length; i++){
                ...
                if(splited_op[i].trim().equals("|")){
                    ...
                    if(j == 6){
                        actual_index = index;
                        System.out.println("\nactual_index+1 ==> " + splited_op[actual_index + 1]);
                    }
                }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mGLView = new OpenGLRGBA_4444Surface(getContext());
